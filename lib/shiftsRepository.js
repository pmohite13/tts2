...
class ShiftRepository {
  ...
  getShiftByCode(shiftCode, callback) {
    console.log("*** ShiftRepository.getShiftByCode" + shiftCode);
  ...
  insertShiftMaster(body, callback) {
    ...
    sql.connect(config, err => {
      ...
      request.input("STARTTIME", sql.DateTime, new Date(body.startTime));      
      request.input("ENDTIME", sql.DateTime, new Date(body.endTime));
      request.input("LUNCHTIME", sql.DateTime, new Date(body.lunchTime));      
      request.input("LUNCHDURATION", sql.Int, body.lunchDuration);
      request.input("LUNCHENDTIME", sql.DateTime, new Date(body.lunchEndTime));     
